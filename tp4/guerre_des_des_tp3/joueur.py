...
class Joueur:
    ...
    def est_elimine(self, carte):
        ...
        """
        # VOTRE CODE ICI
        if not carte.obtenir_cases_joueur(self):
            return True
        else:
            return False
    ...
    def afficher_tour(self):
        ...
        """
        # VOTRE CODE ICI
        afficher("------------------------------------------------------", self.couleur)
        afficher(f"Au tour du joueur {self.couleur} ( {len(self.des_en_surplus)} dés en surplus )", self.couleur)
        afficher("------------------------------------------------------", self.couleur)
    ...
    def afficher_victoire(self):
        ...
        """
        # VOTRE CODE ICI
        afficher(f"{chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)} {chr(8098)}", self.couleur)
